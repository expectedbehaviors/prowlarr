...
<Config>
  ...
  <InstanceName>{{ $configOptions.instanceName | default "Prowlarr" }}</InstanceName>
  ...
  <PostgresMainDb>{{ $configXmlValues.postgresMainDb | default "prowlarr-main" }}</PostgresMainDb>
  <PostgresLogDb>{{ $configXmlValues.postgresLogDb | default "prowlarr-log" }}</PostgresLogDb>
  {{- end }}
